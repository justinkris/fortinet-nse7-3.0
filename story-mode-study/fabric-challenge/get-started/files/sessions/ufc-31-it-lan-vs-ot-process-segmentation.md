# UFC-31 — IT LAN vs OT Process Segmentation
...
- OT Segmentation IT LAN
- OT Segmentation OT-Process

## Learning Objectives

- Understand the two explicit segmentation objectives.
- Reason about separating zones/relationships.
- Connect segmentation to limiting attack movement.

## Mental Model

**Separate zones by required relationships, then explicitly control those relationships**

## Cold-Start Question

> What security problem remains if IT and OT are logically named differently but traffic between them is still broadly permitted?
...
**Challenge style:** Architecture reasoning
