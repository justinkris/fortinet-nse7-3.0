...
- Understand SSL enforcement as a distinct challenge objective.
- Separate enforcement from verification.
- Prepare for the unknown 50-point question without inventing its content.

## Mental Model

**Configure → enforce → verify**

## Cold-Start Question

> If SSL enforcement is configured, what would you need to observe to prove it is actually occurring?
...
**Challenge style:** Mechanism vs evidence
