# UFC-34 — IEC-104, SQL, Application Control and IPS

**Week:** 7  
**Target duration:** 35–40 min  
**Mode:** Socratic + short teaching

## Source Scope

- OT Critical Protocol Inspection (IEC-104 & SQL)
- OT Application Control Baseline (Per Zone)
- OT IPS Visibility without Disruption

## Learning Objectives

- Group the four OT-4 objectives into an inspection/visibility model.
- Distinguish segmentation, protocol inspection, application baseline, and IPS visibility.
- Respect the source phrase 'visibility without disruption'.

## Mental Model

**Segment → identify allowed protocols/apps → inspect → observe**

## Cold-Start Question

> Why might an OT challenge explicitly value IPS visibility without disruption instead of simply asking you to block everything suspicious?
...
**Challenge style:** Integrated OT reasoning
