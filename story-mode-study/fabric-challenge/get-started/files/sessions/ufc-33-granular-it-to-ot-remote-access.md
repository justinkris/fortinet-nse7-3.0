# UFC-33 — Granular IT-to-OT Remote Access
...
- OT Granular IT-to-OT Remote Access

## Learning Objectives

- Understand the goal of granular remote access.
- Move from broad zone-to-zone thinking toward required relationships.
- Prepare for protocol/application inspection.

## Mental Model

**Allow the required source → destination → service relationship, not 'IT to OT' generally**

## Cold-Start Question

> What information would you need before deciding that an IT-to-OT remote-access rule is truly granular?
...
**Challenge style:** Least-necessary access reasoning
