...
- OT Segmentation Disable Catch All

## Learning Objectives

- Understand why a broad fallback can undermine specific segmentation.
- Recognise the source's explicit disable-catch-all objective.
- Reason about policy intent vs effective outcome.

## Mental Model

**Specific segmentation loses value if a broad fallback bypasses it**

## Cold-Start Question

> If every specific OT policy is correct but a catch-all still permits everything else, what have you actually enforced?
...
**Challenge style:** Policy reasoning
