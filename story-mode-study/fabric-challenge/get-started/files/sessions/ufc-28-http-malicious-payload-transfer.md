# UFC-28 — HTTP Malicious Payload Transfer
...
- Detect HTTP Malicious Payload Transfer Between Internal Segments

## Learning Objectives

- Interpret the named malicious HTTP payload transfer objective.
- Distinguish protocol presence from malicious use.
- Connect internal-segment transfer to the broader attack story.

## Mental Model

**Protocol name tells you how; payload and context tell you what it means**

## Cold-Start Question

> Why is 'HTTP between internal segments' not automatically enough to call the traffic malicious?
...
**Challenge style:** Event interpretation
