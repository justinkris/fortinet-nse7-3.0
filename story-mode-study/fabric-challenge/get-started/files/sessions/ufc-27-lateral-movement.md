...
- Correlate Lateral Movement to OT Hosts
- Lateral Movement Port

## Learning Objectives

- Understand lateral movement as movement from one foothold toward additional systems.
- Connect lateral movement to OT hosts.
- Prepare for the optional lateral movement port question without inventing the value.

## Mental Model

**One foothold becomes a path to another system**

## Cold-Start Question

> What additional evidence would you want before calling communication between two internal hosts 'lateral movement'?
...
**Challenge style:** Incomplete-evidence reasoning
