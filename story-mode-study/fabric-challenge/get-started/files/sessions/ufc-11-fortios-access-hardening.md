# UFC-11 — FortiOS Access Hardening
...
- FortiOS access hardening

## Learning Objectives

- Recognise access hardening as management/control-plane protection.
- Separate administrative exposure from ordinary traffic policy.
- Identify what exact implementation details still require official material.

## Mental Model

**Protect the control surface before trusting it to protect everything else**

## Cold-Start Question

> What is fundamentally different about hardening access to FortiOS versus writing a policy for user traffic?
...
**Challenge style:** Category separation
