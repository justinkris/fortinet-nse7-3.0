# UFC-09 — Sanctioned vs Unsanctioned Applications
...
- Sanctioned/Unsanctioned classification
- Application Control
- Application Classification in-action

## Learning Objectives

- Understand sanctioned/unsanctioned classification as a policy signal.
- Separate classification from enforcement.
- Recognise the role of Application Control as a related optional objective.

## Mental Model

**Classify first; decide what the classification means second**

## Cold-Start Question

> What is the difference between labelling an application unsanctioned and actually doing something about it?
...
**Challenge style:** Classification vs action
