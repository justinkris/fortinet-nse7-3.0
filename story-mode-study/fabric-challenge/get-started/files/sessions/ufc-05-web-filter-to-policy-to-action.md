# UFC-05 — Web Filter → Policy → Action
...
- Separate Webfilter profile from firewall policy.
- Trace the full Week 1 chain.
- Diagnose a case where intelligence exists but enforcement does not.

## Mental Model

**Profile defines inspection behaviour; policy places it into traffic enforcement**

## Cold-Start Question

> If the intelligence is present but traffic is unaffected, which broad stage of the workflow would you inspect next?
...
**Challenge style:** Capstone workflow
