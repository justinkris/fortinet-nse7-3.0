# UFC-21 — OT Security Mental Model
...
- Map the OT objectives into detection, investigation, segmentation, and inspection.
- Understand that the source emphasises both visibility and control.
- Prepare for SOC correlation work.

## Mental Model

**See it → correlate it → understand it → contain it**

## Cold-Start Question

> Looking at the OT challenge list, which tasks are about seeing attacker activity and which are about limiting it?
...
**Challenge style:** Domain mapping
