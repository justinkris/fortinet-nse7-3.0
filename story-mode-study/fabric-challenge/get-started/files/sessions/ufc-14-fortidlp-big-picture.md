...
- Build a map of the FortiDLP challenge objectives.
- Separate onboarding/context, policy matching, action, and testing.
- Prepare for individual DLP policy sessions.

## Mental Model

**Observe activity → identify context → match policy → take action**

## Cold-Start Question

> Looking only at the challenge names, what stages of a DLP workflow can you identify?
