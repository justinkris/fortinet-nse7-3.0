# UFC-10 — Custom Tags and Tag Policy
...
- Understand the relationship between custom tags and tag policy.
- Reason through classification → tag → policy.
- Combine Week 2 concepts without topic labels.

## Mental Model

**Classification → Tag → Policy**

## Cold-Start Question

> If a tag is correct but nothing changes for the user, which part of the chain would you investigate next?
...
**Challenge style:** Mixed recognition
