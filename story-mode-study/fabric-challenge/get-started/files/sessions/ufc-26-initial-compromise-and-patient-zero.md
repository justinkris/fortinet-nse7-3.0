# UFC-26 — Initial Compromise and Patient Zero
...
- Reason from evidence toward Patient Zero.
- Avoid assuming first alert equals first compromise.
- Connect the alert-handler objective to investigation.

## Mental Model

**First observed alert ≠ necessarily first compromised host**

## Cold-Start Question

> Why could the first host that triggers an alert be different from Patient Zero?
