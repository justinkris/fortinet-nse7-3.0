...
- Create an Alert Handler to detect Initial Compromise

## Learning Objectives

- Understand why an alert handler exists separately from raw events.
- Use the Initial Compromise objective as the scenario.
- Distinguish event occurrence from meaningful detection.

## Mental Model

**Event + condition → meaningful alert**

## Cold-Start Question

> Why might a raw event not be enough for the SOC to call something 'initial compromise'?
...
**Challenge style:** Detection reasoning
