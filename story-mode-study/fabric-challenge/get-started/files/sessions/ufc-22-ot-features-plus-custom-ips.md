# UFC-22 — OT Features + Custom IPS

**Week:** 5  
**Target duration:** 30–35 min  
**Mode:** Socratic + short teaching

## Source Scope

- Enable OT Features on FortiGate
- OT Custom IPS: MSSQL EXE File Insertion

## Learning Objectives

- Recognise enabling OT features as a prerequisite objective.
- Understand the named MSSQL EXE File Insertion custom IPS task at a conceptual level.
- Avoid inventing an exact signature from the source.

## Mental Model

**Enable visibility/control capabilities → define what suspicious pattern matters**

## Cold-Start Question

> What does the phrase 'MSSQL EXE File Insertion' suggest the IPS rule is intended to notice?
...
**Challenge style:** Concept inference with source limits
