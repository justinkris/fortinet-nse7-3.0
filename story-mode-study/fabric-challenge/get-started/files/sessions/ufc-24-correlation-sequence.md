...
- Configure the Correlation Sequence for the Alert Handler

## Learning Objectives

- Understand why event order matters.
- Build an attack story from ordered clues.
- Prepare to distinguish sequence from criteria.

## Mental Model

**One event is a clue; ordered related events tell a story**

## Cold-Start Question

> If the same three events happen in a different order, could they tell a different story? Why?
...
**Challenge style:** Sequence reasoning
