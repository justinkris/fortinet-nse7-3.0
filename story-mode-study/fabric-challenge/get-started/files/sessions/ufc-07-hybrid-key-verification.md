# UFC-07 — Hybrid Key Verification
...
- Focus on evidence rather than intended configuration.
- Reason about what would count as proof of the intended negotiated result.
- Avoid treating configuration presence as success.

## Mental Model

**Intention lives in config; truth lives in observed result**

## Cold-Start Question

> What kind of evidence would be stronger than simply seeing the configured setting?
...
**Challenge style:** Evidence reasoning
