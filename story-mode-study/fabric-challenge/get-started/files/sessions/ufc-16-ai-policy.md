...
- Recognise AI Policy as a distinct DLP objective.
- Separate policy creation from testing.
- Reason about what a successful test should demonstrate conceptually.

## Mental Model

**Create the rule → generate the condition → prove the outcome**

## Cold-Start Question

> Why is 'Test the AI Policy' worth a separate 100 points from creating it?
...
**Challenge style:** Policy + verification
