...
- File origin policy
- Test the file origin policy

## Learning Objectives

- Recognise file-origin reasoning.
- Contrast file origin with file download.
- Use the distinction in scenario questions.

## Mental Model

**Origin asks where it came from; download asks about the transfer event**

## Cold-Start Question

> If two files are downloaded identically but originated from different sources, which listed DLP objective becomes especially relevant?
