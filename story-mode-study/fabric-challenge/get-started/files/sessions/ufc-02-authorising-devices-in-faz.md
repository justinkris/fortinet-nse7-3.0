# UFC-02 — Authorising Devices in FAZ

**Week:** 1  
**Target duration:** 20–25 min  
**Mode:** Socratic + short teaching

## Source Scope

- Authorize devices in FAZ

## Learning Objectives

- Understand the role of device authorisation in the listed challenge.
- Recognise authorisation as an explicit workflow step.
- Reason about later tasks that may depend on successful onboarding.

## Mental Model

**Establish the relationship before relying on the information**

## Cold-Start Question

> Why would device authorisation appear before the later intelligence and policy tasks?
...
**Challenge style:** Troubleshooting prerequisite
