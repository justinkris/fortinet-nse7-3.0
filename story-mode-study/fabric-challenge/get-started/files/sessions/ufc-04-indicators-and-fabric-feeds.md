# UFC-04 — Indicators and Fabric Feeds
...
- Distinguish the listed concepts of Indicators and Fabric Feeds.
- Explain why the challenge separates them.
- Trace how intelligence could move toward enforcement without inventing unsupported product detail.

## Mental Model

**Indicator = fact; feed = delivery of usable facts**

## Cold-Start Question

> If an indicator represents something known to be important, why might a separate feed still be needed?
...
**Challenge style:** Classification of objects
