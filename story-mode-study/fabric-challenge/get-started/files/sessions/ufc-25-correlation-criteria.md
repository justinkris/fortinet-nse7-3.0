...
- Configure the Correlation Criteria
- Correlation Operator

## Learning Objectives

- Understand criteria as the logic determining which events belong together.
- Contrast criteria with sequence.
- Prepare for the optional correlation operator question without guessing its answer.

## Mental Model

**Sequence asks 'in what order?'; criteria asks 'which belong together?'**

## Cold-Start Question

> Two users generate similar events at the same time. What kind of logic would help decide whether those events belong to one incident?
...
**Challenge style:** Correlation reasoning
