...
- Test the file download policy

## Learning Objectives

- Recognise the file download objective.
- Reason about direction/context of file activity.
- Separate policy design from testing.

## Mental Model

**What happened to the file, in which direction, and what should policy do?**

## Cold-Start Question

> What makes a file download scenario different from merely knowing where a file originally came from?
...
**Challenge style:** Scenario discrimination
