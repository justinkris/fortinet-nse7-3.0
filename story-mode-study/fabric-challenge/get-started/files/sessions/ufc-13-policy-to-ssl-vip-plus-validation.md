# UFC-13 — Policy to SSL VIP + Validation
...
- Firewall policy to SSL VIP Virtual server
- SSL VIP validation

## Learning Objectives

- Separate VIP definition, policy permission, and validation.
- Troubleshoot the broad categories when a published service fails.
- Revisit configured vs working.

## Mental Model

**VIP defines the presented service; policy permits traffic; validation proves the result**

## Cold-Start Question

> The VIP exists but clients cannot connect. What are the first broad categories you would separate before changing anything?
...
**Challenge style:** Troubleshooting
