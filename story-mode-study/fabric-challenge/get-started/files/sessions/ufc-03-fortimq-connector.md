...
- Place the FortiMQ Connector in the challenge workflow.
- Distinguish configuring a connector from proving it works in action.
- Identify useful verification evidence conceptually.

## Mental Model

**Connected ≠ proven working**

## Cold-Start Question

> If a connector exists in the configuration, what else would you want to see before calling the workflow operational?
...
**Challenge style:** Configuration vs verification
