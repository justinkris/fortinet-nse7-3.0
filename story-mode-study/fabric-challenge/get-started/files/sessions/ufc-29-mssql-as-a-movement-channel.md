# UFC-29 — MSSQL as a Movement Channel
...
- MSSQL EXE File Insertion
- Lateral Tool Transfer via MSSQL Table Data
- SQL Infiltration Pattern

## Learning Objectives

- Connect MSSQL EXE file insertion, tool transfer via table data, and SQL infiltration pattern.
- Reason about abuse of an allowed protocol.
- Revisit UFC-22 through a later-stage attack scenario.

## Mental Model

**Do not judge traffic only by protocol name; ask what it is carrying or accomplishing**

## Cold-Start Question

> If MSSQL is normally allowed, what changes would make its traffic suspicious in this challenge context?
...
**Challenge style:** Attack-chain reasoning
