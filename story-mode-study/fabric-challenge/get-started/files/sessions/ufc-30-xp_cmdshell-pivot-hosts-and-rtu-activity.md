# UFC-30 — xp_cmdshell, Pivot Hosts and RTU Activity
...
- Suspicious xp_cmdshell Execution
- Command Execution Signature
- Pivot Host Identification
- RTU Commands from unusual devices
- RTU Target
- Enable FortiAI for User

## Learning Objectives

- Connect command execution, pivoting, unusual RTU commands, and FortiAI enablement.
- Reconstruct a plausible attack chain only at the level supported by the source.
- Distinguish host role from event type.

## Mental Model

**Initial compromise → transfer → execution → pivot → OT interaction**

## Cold-Start Question

> If xp_cmdshell activity appears on one host and unusual RTU commands originate from another, what questions help you identify the pivot?
...
**Challenge style:** Timed evidence interpretation
