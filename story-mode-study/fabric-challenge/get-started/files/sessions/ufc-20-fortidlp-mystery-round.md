...
- FortiDLP-3 Questions 1–6
- All known FortiDLP objectives

## Learning Objectives

- Mix all known DLP objectives.
- Practise recognition without announcing the topic.
- Prepare for six unknown FortiDLP-3 questions without inventing their content.

## Mental Model

**Context → match → action → proof**

## Cold-Start Question

> I will give you a DLP scenario without naming the policy type. What clues will you use to classify it?
...
**Challenge style:** Lightly timed mixed round
