# UFC-35 — Full Round 1 Simulation
...
- All supplied Round 1 objectives

## Learning Objectives

- Mix every known Round 1 domain.
- Remove topic labels.
- Test recognition, troubleshooting, evidence, and speed.
- Use only supported objectives; do not invent hidden UFC answers.

## Mental Model

**Recognise → reason → verify → act**

## Cold-Start Question

> You will not be told the topic. For each scenario, first identify what the challenge is actually testing.
...
**Challenge style:** Timed mixed simulation
