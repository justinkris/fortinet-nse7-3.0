# UFC-15 — Agent Onboarding, SaaS Apps and Policy Groups
...
- Understand why these three FortiDLP-1 objectives form a foundation.
- Reason about endpoint, application context, and policy scope.
- Reconstruct the FortiDLP-1 workflow from memory.

## Mental Model

**Endpoint → application context → policy scope**

## Cold-Start Question

> Why would it be difficult to apply useful policy if the endpoint or SaaS context had not been established first?
...
**Challenge style:** Workflow reconstruction
