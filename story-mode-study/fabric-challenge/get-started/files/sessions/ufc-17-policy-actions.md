...
- Separate matching criteria from action.
- Explain why a correct match with the wrong action is still a failed policy outcome.
- Apply the distinction to AI/download/origin scenarios.
...
> A policy matches exactly the intended activity but the wrong thing happens. Which logical part is most suspect?
...
**Challenge style:** Reasoning decomposition
