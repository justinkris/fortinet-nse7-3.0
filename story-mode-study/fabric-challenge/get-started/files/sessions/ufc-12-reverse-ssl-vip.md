...
- Build the traffic-flow mental model for a reverse SSL VIP.
- Separate client-facing publication from backend service.
- Prepare for policy and validation in the next session.

## Mental Model

**Client → VIP/service → protected server**

## Cold-Start Question

> What role is the VIP playing that the backend server itself is not?
...
**Challenge style:** Traffic-flow reasoning
